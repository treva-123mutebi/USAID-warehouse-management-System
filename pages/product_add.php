...
include('../dist/includes/dbcon.php');
	...
	$query2=mysqli_query($con,"select * from product where prod_name='$name' and branch_id='$branch'")or die(mysqli_error($con));
		...
		{	
			...
			mysqli_query($con,"INSERT INTO product(prod_name,expirydate,prod_price,prod_pic,cat_id,prod_qty,supplier_id,branch_id)
			VALUES('$name','$expirydate','$price','$pic','$category','$prod_qty','$supplier','$branch')")or die(mysqli_error($con));
