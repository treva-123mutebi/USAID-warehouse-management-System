...
<html>
  ...
  <body class="hold-transition skin-<?php echo $_SESSION['skin'];?> layout-top-nav">
    <div class="wrapper">
	      ...
	      <div class="col-md-4">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add New Job Offer</h3>
                </div>
                <div class="box-body">
                  <!-- Date range -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="cat_name" placeholder="Job Offer" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                  <div class="form-group">
                    <label for="date">Job Description</label>
                    <div class="input-group col-md-12">
                      <textarea type="text" class="form-control pull-right" id="date" name="itemdesc" placeholder="Job Offer" required></textarea>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                  <div class="form-group">
                    <label for="date">Status</label>
                    <div class="input-group col-md-12">
                    <select name="status" id="date" required>
            ...
            <div class="col-xs-8">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title">Job Offer List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
      ...
      <th>Description</th>
      <th>Status</th>
      <th>Number Of Job Applicants</th>
			<th>Action</th>
                      </tr>
                    </thead>
                    <tbody>
...
?>
                      <tr>
                        ...
                        <td><?php echo $row1['total_applicants'];?></td>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Update Job Offer Details</h4>
              </div>
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="cat_update.php" enctype='multipart/form-data'>
                
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Job Offer</label>
        ...
        <div class="form-group">
					<label class="control-label col-lg-3" for="name">Job Description</label>
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['cat_id'];?>" required>  
          <textarea name="itemdesc" cols="45" rows="10" id="txt_descripcion"><?php echo htmlspecialchars($row['itemdesc']);?></textarea>  
					</div>
        </div>
        <div class="form-group">
					<label class="control-label col-lg-3" for="name">Status</label>
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="status" value="" required>  
