<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href = "user.php"><i class="fa fa-users"></i> Request For Quotation<span class="fa fa-chevron-right"></span></a></li>     
                  ...
                  <li><a href = "branch.php"><i class="fa fa-building"></i> Product Quantity <span class="fa fa-chevron-right"></span></a>
                    <!--- <ul class="nav child_menu">
                  ...
                  <!--<li><a href = "itemlist.php"><i class="fa fa-users"></i>Item List<span class="fa fa-chevron-right"></span></a></li>-->
