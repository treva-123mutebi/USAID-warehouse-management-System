...
<?php
    ...
    $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from sales natural join requestforquotation NATURAL JOIN supplier natural join customer where branch_id='$branch' order by ItemID desc LIMIT 0,1")or die(mysqli_error($con));
...
?>    
                   ...
                   <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th><b><u>Request for Invoice</u></b></th>
                      </tr>
                      <tr>
                    ...
                    <thead>
                      ...
                      <tr>
                        <th>Sent to</th>
                        <th><u><?php echo $suppliername;?></u></th>
                        <th>Date</th>
                        <th><u><?php echo date("M d, Y");?> Time <?php echo date("h:i A");?></u></th>
                      </tr>
                      <tr>
                        <th>Address</th>
                        <th><u><?php echo $supplieraddress;?></u></th>
                        <th>Contact</th>
                        <th><u><?php echo $suppliercontact;?></u></th>
                        <th>TIN</th>
                  ...
                  <table class="table">
                    ...
                    <tbody>
<?php
		$query=mysqli_query($con,"select * from sales_details natural join requestforquotation NATURAL JOIN supplier natural join product where sales_id='$sid'")or die(mysqli_error($con));
			$grand=0;
...
?>
                      <tr>
                        ...
                        <!--<td>pc/s</td>-->
                        <td class="record"><?php echo $row['ItemSpecs'];?></td>
                        <td class="record"><?php echo $row['Unitofmeasure'];?></td>
                        <td class="record"><?php echo $row['Quantityordered'];?></td>
            						<td class="record"><?php echo $row['Remarks'];?></td>
            						<td style="text-align:right"><?php echo $row['dateneeded'];?></td>
...
?>                      
                ...
                <a class = "btn btn-primary btn-print" href = "user.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back</a>
              </div><!-- /.box -->
            </div><!-- /.col (right) -->
